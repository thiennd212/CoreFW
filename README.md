...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f99c77cc-6907-42a5-ba35-1bc5ada143c2
```

> `f99c77cc-6907-42a5-ba35-1bc5ada143c2` is the password of the certificate, you can change it to any password you want.
